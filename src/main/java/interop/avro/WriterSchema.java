...
public class WriterSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7716611310950745152L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WriterSchema\",\"namespace\":\"interop.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_color\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public WriterSchema(java.lang.CharSequence name, java.lang.Integer favorite_number, java.lang.CharSequence favorite_color) {
    this.name = name;
   ...
   */
  public static interop.avro.WriterSchema.Builder newBuilder() {
    return new interop.avro.WriterSchema.Builder();
  }
   ...
   * @return A new WriterSchema RecordBuilder
   */
  public static interop.avro.WriterSchema.Builder newBuilder(interop.avro.WriterSchema.Builder other) {
    if (other == null) {
      return new interop.avro.WriterSchema.Builder();
    } else {
      return new interop.avro.WriterSchema.Builder(other);
    }
  }
   ...
   * @return A new WriterSchema RecordBuilder
   */
  public static interop.avro.WriterSchema.Builder newBuilder(interop.avro.WriterSchema other) {
    if (other == null) {
      return new interop.avro.WriterSchema.Builder();
    } else {
      return new interop.avro.WriterSchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WriterSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(interop.avro.WriterSchema.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(interop.avro.WriterSchema other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder setFavoriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder clearFavoriteNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder setFavoriteColor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public interop.avro.WriterSchema.Builder clearFavoriteColor() {
      favorite_color = null;
